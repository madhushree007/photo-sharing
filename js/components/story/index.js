                   ...
                   <Image source={require('../../../images/NewsIcons/5.jpg')} style={styles.newsPoster}>
                    ...
                    <TouchableOpacity>
                        <View style={styles.newsPosterContent}>
                            <Text numberOfLines={2} style={styles.newsPosterHeader}>Contrary to popular belief, Lorem Ipsum is not simply random text.</Text>
                        </View>
                    </TouchableOpacity>
                   </Image>
                  </View>
                  ...
                  <View style={{backgroundColor: '#fff'}}>
                        ...
                        <View style={styles.newsContent}>
                            ...
                            <Grid style={{paddingBottom: 20}}>
                                ...
                                <Col><TouchableOpacity style={styles.newsTypeView}><Text style={styles.newsTypeText}>ENVIRONMENT</Text></TouchableOpacity></Col>
                            </Grid>
                            <Text  style={styles.newsHeader}>Lorem Ipsum is simply dummy 
                        ...
                        <View style={{padding: 20}}>
                            <View style={styles.newsCommentContainer}>
                                <Text  style={styles.newsComment}>"It has roots in a piece of classical Latin literature from 45 BC, 
                                    making it over 2000 years old. Richard McClintock, a Latin professor 
                                    at Hampden-Sydney College"</Text>
                                <Text style={styles.newsComment}>- JOHN</Text>
                            </View>

                            <Text  style={[styles.newsHeader, {paddingBottom: 20,paddingTop: 20,fontWeight: '700'}]}>So, is Lorem Ipsum, dummy 
                             text of the printing and typesetting industry helpfull?</Text>
                            <View style={{paddingBottom: 20}}>
                                <Text  style={styles.newsHeader}>There are many variations of passages of Lorem Ipsum available, 
                                but the majority have suffered alteration in some form, by injected 
                                humour, or randomised words which don't look even slightly believable.
                                If you are going to use a passage of Lorem Ipsum, you need to be sure 
                                there isn't anything embarrassing hidden in the middle of text.</Text>
                            </View>
                            <View style={{paddingBottom: 20,paddingTop: 10}}>
                                <Text  style={styles.newsHeader}>All the Lorem Ipsum generators on the Internet tend 
