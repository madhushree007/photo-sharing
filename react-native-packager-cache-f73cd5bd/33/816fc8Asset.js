...
var pickScale = function pickScale(meta) {
  ...
  if (_Constants.manifest.xde) {
    ...
    return {
      uri: _Constants.manifest.bundleUrl.match(/^https?:\/\/.*?\//)[0] + meta.httpServerLocation.replace(/^\/?/, '') + '/' + meta.name + suffix + '.' + meta.type + '?platform=' + _reactNative.Platform.OS + '&hash=' + meta.hash,
      hash: hash
    };
  }
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              _context.next = 12;
              return regeneratorRuntime.awrap(_reactNative.NativeModules.ExponentFileSystem.getInfoAsync(path, { cache: true, md5: true }));
