...
var _mapPropsToStyleNames = require('../Utils/mapPropsToStyleNames');var _mapPropsToStyleNames2 = _interopRequireDefault(_mapPropsToStyleNames);function _interopRequireDefault(obj) {
  ...
  function PickerNB(props) {
    _classCallCheck(this, PickerNB);var _this = _possibleConstructorReturn(this, (PickerNB.__proto__ || Object.getPrototypeOf(PickerNB)).call(this, props));
    ...
    _this.state = {
      ...
      childrenArray.forEach(function (child) {
        if (child.type === _Button.Button) {
          newChildren.push(_react2.default.cloneElement(child, { onPress: function onPress() {
              _this2._setModalVisible(false);
            } }));
        } else {
      ...
      return _react2.default.createElement(_Button.Button, {
        ...
        picker: true,
        transparent: true,
        onPress: onPress }, _react2.default.createElement(_Text.Text, { note: this.props.note, style: this.props.textStyle }, text), this.props.iosIcon === undefined ? null : this.renderIcon());
    } }, { key: 'renderHeader', value: function renderHeader() {
      var _this4 = this;
      return this.props.headerComponent ? this.modifyHeader() : _react2.default.createElement(_Header.Header, null, _react2.default.createElement(_Left.Left, null, _react2.default.createElement(_Button.Button, {
        style: { shadowOffset: null, shadowColor: null, shadowRadius: null, shadowOpacity: null },
        transparent: true, onPress: function onPress() {
          _this4._setModalVisible(false);
        } }, _react2.default.createElement(_Text.Text, null, 'Back'))), _react2.default.createElement(_Body.Body, null, _react2.default.createElement(_Title.Title, null, this.props.iosHeader ? this.props.iosHeader : 'Select One')), _react2.default.createElement(_Right.Right, null));
    } }, { key: 'render', value: function render() {
      var _this5 = this;
      return _react2.default.createElement(_reactNative.View, { ref: function ref(c) {
          return _this5._root = c;
        } }, this.renderButton(), _react2.default.createElement(_reactNative.Modal, {
        animationType: 'slide',
        transparent: false,
        visible: this.state.modalVisible,
        onRequestClose: function onRequestClose() {
          _this5._setModalVisible(false);
        } }, _react2.default.createElement(_Container.Container, null, this.renderHeader(), _react2.default.createElement(_Content.Content, null, _react2.default.createElement(_reactNative.ListView, {
        dataSource: this.state.dataSource,
        renderRow: function renderRow(child) {
          return _react2.default.createElement(_ListItem.ListItem, {
            ...
            } }, _react2.default.createElement(_Text.Text, { style: _this5.props.itemTextStyle }, child.props.label), _react2.default.createElement(_Right.Right, null, child.props.value === _this5.props.selectedValue ? _react2.default.createElement(_Radio.Radio, { selected: true }) : _react2.default.createElement(_Radio.Radio, { selected: false })));
        } })))));
    } }]);return PickerNB;
}(_react.Component);
...
PickerNB.propTypes = _extends({}, _reactNative.View.propTypes);
