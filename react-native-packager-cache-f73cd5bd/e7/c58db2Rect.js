...
var Rect = (_temp2 = _class = function (_Shape) {
    ...
    function Rect() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Rect.__proto__ || Object.getPrototypeOf(Rect)).call.apply(_ref, [this].concat(args))), _this), _initialiseProps.call(_this), _temp), _possibleConstructorReturn(_this, _ret);
    }
    ...
    _createClass(Rect, [{
        ...
        value: function render() {
            ...
            }, this.extractProps(_extends({}, props, {
                x: null,
                y: null
            })), {
                x: props.x.toString(),
