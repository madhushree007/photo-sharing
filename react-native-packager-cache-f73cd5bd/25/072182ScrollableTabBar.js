...
var _index3 = _interopRequireDefault2(_index2);
...
var _reactTransformHmrLibIndexJs2 = (0, _index3.default)({
  filename: '/Users/madhushree/Sites/projects/React/FlatApp/node_modules/native-base/dist/src/basic/Tabs/ScrollableTabBar.js',
...
}var React = require('react');var ReactNative = require('react-native');var View = ReactNative.View,
...
var ScrollableTabBar = _wrapComponent('ScrollableTabBar')(React.createClass({ displayName: 'ScrollableTabBar',
  propTypes: {
  ...
  renderTab: function renderTab(name, page, isTabActive, onPressHandler, onLayoutHandler, tabStyle, activeTabStyle, textStyle, activeTextStyle, tabHeaderStyle) {
    ...
    if (typeof name === 'string') {
      return React.createElement(Button, {
        ...
        onLayout: onLayoutHandler }, React.createElement(_index.TabHeading, { scrollable: true, style: isTabActive ? activeTabStyle : tabStyle, active: isTabActive }, React.createElement(_index.Text, { style: isTabActive ? activeTextStyle : textStyle }, name)));
    } else {
      return React.createElement(Button, {
        key: _lodash2.default.random(1.2, 5.2),
        onPress: function onPress() {
          return onPressHandler(page);
        } }, React.createElement(_index.TabHeading, { scrollable: true, style: tabHeaderStyle, active: isTabActive }, headerContent));
    }
  },
...
var StyledTab = (0, _theme.connectStyle)('NativeBase.ScrollableTab', {}, mapPropsToStyleNames)(ScrollableTabBar);exports.ScrollableTab = StyledTab;
