...
var Text = (_temp2 = _class = function (_Shape) {
    ...
    _createClass(Text, [{
        ...
        value: function render() {
            ...
            }, this.extractProps(_extends({}, props, { x: x, y: y })), (0, _extractText2.default)(props), {
                __source: {
    ...
    return Text;
}(_Shape3.default), _class.displayName = 'Text', _class.propTypes = _extends({}, _props.pathProps, {
