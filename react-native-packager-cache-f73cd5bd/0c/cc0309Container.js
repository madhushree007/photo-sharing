Object.defineProperty(exports, "__esModule", { value: true });exports.Container = undefined;var _extends = Object.assign || function (target) {
...
var _Text = require('./Text');function _interopRequireDefault(obj) {
  ...
  _inherits(Container, _Component);function Container() {
    _classCallCheck(this, Container);return _possibleConstructorReturn(this, (Container.__proto__ || Object.getPrototypeOf(Container)).apply(this, arguments));
      ...
      return _react2.default.createElement(_reactNative.View, _extends({ ref: function ref(c) {
        ...
        } }, this.props), this.props.children, _react2.default.createElement(_ToastContainer.ToastContainer, { ref: function ref(c) {
          _ToastContainer.ToastContainer.toastInstance = c;
        } }), _react2.default.createElement(_Actionsheet.ActionSheetContainer, { ref: function ref(c) {
